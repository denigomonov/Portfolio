...
<img width="1920" height="1156" alt="Web 1920 – 4" src="https://github.com/user-attachments/assets/9ece2ee2-beaf-40bc-8697-7c2cedb95b04" width="600" />
...
* Engineered features and built custom plots for metric analysis, geo-mapping and forecasting via Plotly, public app launched via Heroku
...
* Collected data and maintained it on Kaggle with achieving _Top-20 Most Voted, 1850+ Votes, Gold medal_
